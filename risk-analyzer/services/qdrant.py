...
QDRANT_HOST = "utrack-qdrant"  # Default value, override with environment
QDRANT_PORT = 6333
QDRANT_API_KEY = None
QDRANT_COLLECTION = "utrack_vectors"
...
async def init_qdrant() -> QdrantClient:
    ...
    logger.info(f"Qdrant initialized with collection: {QDRANT_COLLECTION}")
    return _client
