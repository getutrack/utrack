...
from risk_analyzer.services.qdrant import store_embeddings
from risk_analyzer.services.neo4j import (
    create_project_node,
    create_issue_node,
    create_comment_node,
...
# Configuration (to be loaded from .env file)
RABBITMQ_HOST = "utrack-mq"
RABBITMQ_PORT = 5672
RABBITMQ_USER = "utrack"
RABBITMQ_PASSWORD = "utrack"
RABBITMQ_VHOST = "utrack"
EVENT_EXCHANGE = "utrack_events"
VECTOR_QUEUE = "vector_updates"
GRAPH_QUEUE = "graph_updates"
