...
export const BillingRoot = () => (
  <section className="w-full overflow-y-auto bg-white text-black">
    <div>
    ...
    <div className="py-6">
      <div>
        ...
        <p className="mb-3 text-sm text-custom-text-200">You are currently using the enterprise plan</p>
