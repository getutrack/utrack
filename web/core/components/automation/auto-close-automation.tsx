...
// ui
import { CustomSelect, CustomSearchSelect, ToggleSwitch, StateGroupIcon, DoubleCircleIcon, Loader } from "@utrack/ui";
// component
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="">
              ...
              <p className="text-sm tracking-tight text-custom-text-200">
                Utrack will automatically close issues that haven{"'"}t been completed or canceled.
              </p>
            </div>
          </div>
          <ToggleSwitch
