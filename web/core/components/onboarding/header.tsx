...
// images
import BlueUtrackLogoWithoutText from "@/public/utrack-logos/blue-without-text.png";
// components
  ...
  return (
    <div className="flex w-full items-center justify-between font-semibold ">
      <div className="flex items-center gap-x-2">
        <Image src={BlueUtrackLogoWithoutText} height={30} width={30} alt="Utrack Logo" className="mr-3" />
