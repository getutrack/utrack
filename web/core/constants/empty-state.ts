...
const emptyStateDetails = {
  ...
  [EmptyStateType.WORKSPACE_DASHBOARD]: {
    ...
    description:
      " Welcome to Utrack, we are excited to have you here. Create your first project and track your issues, and this page will transform into a space that helps you progress. Admins will also see items which help their team progress.",
    path: "/empty-state/onboarding/dashboard",
    // path: "/empty-state/onboarding/",
    primaryButton: {
      text: "Build your first project",
      comicBox: {
        title: "Everything starts with a project in Utrack",
  ...
  [EmptyStateType.WORKSPACE_SETTINGS_API_TOKENS]: {
    ...
    description:
      "Utrack APIs can be used to integrate your data in Utrack with any external system. Create a token to get started.",
  ...
  [EmptyStateType.PROFILE_ACTIVITY]: {
    ...
    description:
      "Get started by creating a new issue! Add details and properties to it. Explore more in Utrack to see your activity.",
  ...
  [EmptyStateType.PROJECT_NO_ISSUES]: {
    ...
    primaryButton: {
      ...
      comicBox: {
        title: "Issues are building blocks in Utrack.",
        description:
          "Redesign the Utrack UI, Rebrand the company, or Launch the new fuel injection system are examples of issues that likely have sub-issues.",
      },
    },
    accessType: "project",
    access: [EUserPermissions.ADMIN, EUserPermissions.MEMBER],
  ...
  [EmptyStateType.PROJECT_PAGE]: {
    ...
    title: "Write a note, a doc, or a full knowledge base. Get Galileo, Utrack’s AI assistant, to help you get started",
    description:
      "Pages are thoughts potting space in Utrack. Take down meeting notes, format them easily, embed issues, lay them out using a library of components, and keep them all in your project’s context. To make short work of any doc, invoke Galileo, Utrack’s AI, with a shortcut or the click of a button.",
  ...
  [EmptyStateType.DISABLED_PROJECT_PAGE]: {
    ...
    description:
      "Pages are thought spotting space in Utrack. Take down meeting notes, format them easily, embed issues, lay them out using a library of components, and keep them all in your project’s context. Enable the pages feature to start creating them in your project.",
    accessType: "project",
    access: [EUserPermissions.ADMIN],
