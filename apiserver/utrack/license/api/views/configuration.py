...
from utrack.license.api.permissions import InstanceAdminPermission
from utrack.license.models import InstanceConfiguration
from utrack.license.api.serializers import InstanceConfigurationSerializer
from utrack.license.utils.encryption import encrypt_data
from utrack.utils.cache import cache_response, invalidate_cache
from utrack.license.utils.instance_value import (
...
class EmailCredentialCheckEndpoint(BaseAPIView):
    ...
    def post(self, request):
        ...
        subject = "Email Notification from Utrack"
        message = (
            "This is a sample email notification sent from Utrack application."
        )
        # Send the email
        try:
