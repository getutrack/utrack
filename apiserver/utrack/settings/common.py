...
service_name = os.environ.get("SERVICE_NAME", "utrack-ce-api")
...
MIDDLEWARE = [
    ...
    "utrack.authentication.middleware.session.SessionMiddleware",
    ...
    "utrack.middleware.api_log_middleware.APITokenLogMiddleware",
]
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "utrack.authentication.adapter.exception.auth_exception_handler",
}
...
STORAGES["default"] = {
    "BACKEND": "utrack.settings.storage.S3Storage",
}
...
CELERY_IMPORTS = (
    # scheduled tasks
    "utrack.bgtasks.issue_automation_task",
    "utrack.bgtasks.exporter_expired_task",
    "utrack.bgtasks.file_asset_task",
    "utrack.bgtasks.email_notification_task",
    "utrack.bgtasks.api_logs_task",
    "utrack.license.bgtasks.tracer",
    # management tasks
    "utrack.bgtasks.dummy_data_task",
)
...
SESSION_ENGINE = "utrack.db.models.session"
...
CSRF_FAILURE_VIEW = "utrack.authentication.views.common.csrf_failure"
